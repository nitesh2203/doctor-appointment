        ...
        <div className='flex items-center gap-4 '>
           {
            ...
            </div>: <button onClick={()=>{navigate("/login")}} className='bg-primary text-white px-8 py-3 rounded-full font-light hidden md:block'>Create Account</button>//means abhi hum login hai to token true hai and button removed hai 
           }
